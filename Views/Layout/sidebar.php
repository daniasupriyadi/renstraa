...
function isPageActive($pageName)
{
  ...
  // jika $pageName berupa string ubah ke array
  if (!is_array($pageName)) {
    $pageName = [$pageName];
  }

  foreach ($pageName as $pageNames) {
    if ($currentPage == $pageNames) {
      return 'active';
    }
  }
  return '';
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      <span class="app-brand-logo demo">
        <!-- <svg width="25" viewBox="0 0 25 42" version="1.1" xml:href="../../assets/img/"> -->
        <defs>
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboard -->
    <li class="menu-item <?php echo isPageActive('beranda.php') ?>">
      <a href="<?php echo $base_url ?>/Views/beranda.php" class="menu-link">
    ...
    <li class="menu-item open <?php echo isPageActive(['daftar_unit.php', 'tambah_unit.php', 'edit_unit.php', 'instrument_renstra.php']) ?>">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item <?php echo isPageActive(['instrument_renstra.php', 'tambah_instrumen_renstra.php', 'ikk.php', 'ikuk.php', 'iksk.php']) ?>">
    ...
    <form id="logoutForm" action="../Controllers/Authenticate/logout_controller.php" method="post" style="display: none;">
      <!-- Hidden form for logout -->
    </form>

    <li class="menu-item <?php echo isPageActive('keluar.php') ?>">
      <a href="#" class="menu-link" onclick="document.getElementById('logoutForm').submit();" style="cursor: pointer;">
